...
function ArticleCardInner({ article }: { article: Article }) {
  ...
  return (
    ...
    >
      ...
      <p className="text-neutral-700 dark:text-neutral-200 mb-4 flex-1">{article.summary}</p>
      <div className="flex items-center gap-2 mb-2">
        ...
        <span className="text-sm text-neutral-700 dark:text-neutral-300">{article.author.name}</span>
      </div>
